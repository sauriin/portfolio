        ...
        <div className="grid gap-4 sm:gap-5 lg:grid-cols-2">
          {chronicles.map((chronicle) => (
            <button
              ...
              className="group glass-panel min-h-[260px] rounded-2xl p-5 text-left transition duration-300 hover:-translate-y-1 hover:border-chronicle-primary/60 hover:shadow-glow active:translate-y-0 sm:min-h-[320px] sm:rounded-[1.75rem] sm:p-7 touch-manipulation"
            >
              ...
              <h3 className="mb-4 sm:mb-5 text-2xl font-semibold tracking-[-0.03em] sm:text-3xl">{chronicle.title}</h3>
              <p className="max-w-xl text-sm leading-6 text-chronicle-muted sm:text-base sm:leading-7">{chronicle.discoverySummary}</p>
